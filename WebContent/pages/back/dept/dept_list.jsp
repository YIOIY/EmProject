				...
				<div class="modal-body">
							...
							<table id="actionsTab" class="table table-bordered table-hover table-condensed table-responsive">
								<thead>
									<tr>
										...
										<td style="width:5%;" class="text-center"><strong>状态</strong></td>
										<td style="width:10%;" class="text-center"><strong>工资</strong></td>
										<td style="width:10%;" class="text-center"><strong>佣金</strong></td>
					...
					<div class="row">
						<div class="col-md-4 col-md-offset-8">
							<ul class="pager">
								<li id="pLi"><span id="previousBut">上一页</span></li>
								<li id="nLi"><span id="nextBut">下一页</span></li>
							</ul>
						</div>
					</div>
				</div>
